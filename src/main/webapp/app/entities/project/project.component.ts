...
export class ProjectComponent implements OnInit, OnDestroy {
  ...
  public isProvisioningVisible(project: IProject) : boolean {
	if(project.properties != null){
		//		return project.quotaDiskGB != null && project.quotaDiskGB >= 0 && project.quotaCpuMillicore != null && project.quotaCpuMillicore >= 0  && project.quotaMemMB != null && project.quotaMemMB >= 0 && JSON.parse(project.properties.replace(/'/g, '"')).soe_endpoint != null;
		return project.quotaDiskGB != null && project.quotaDiskGB >= 0 && project.quotaCpuMillicore != null && project.quotaCpuMillicore >= 0  && project.quotaMemMB != null && project.quotaMemMB >= 0 && project.properties.includes('\'soe_endpoint\':');
	}
	return false;
  }
