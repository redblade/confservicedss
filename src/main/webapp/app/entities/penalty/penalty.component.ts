...
export class PenaltyComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.penaltyService
      ...
      .subscribe(
        (res: HttpResponse<IPenalty[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPenalties(): void {
    this.eventSubscriber = this.eventManager.subscribe('penaltyListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPenalty[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
