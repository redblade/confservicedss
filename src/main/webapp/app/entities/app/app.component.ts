...
export class AppComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.subscription = this.source.subscribe(() => this.eventManager.broadcast('appListModification'));	
  }
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.appService
      ...
      .subscribe(
        (res: HttpResponse<IApp[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInApps(): void {
    this.eventSubscriber = this.eventManager.subscribe('appListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IApp[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
