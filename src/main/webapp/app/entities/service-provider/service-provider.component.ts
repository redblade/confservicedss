...
export class ServiceProviderComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.serviceProviderService
      ...
      .subscribe(
        (res: HttpResponse<IServiceProvider[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInServiceProviders(): void {
    this.eventSubscriber = this.eventManager.subscribe('serviceProviderListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IServiceProvider[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
