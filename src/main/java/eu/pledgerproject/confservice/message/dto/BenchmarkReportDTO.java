...
public class BenchmarkReportDTO {
	...
	public BenchmarkReportDTO(String metric, String tool, String workloadId, String category, Long pledgerInfrastructure, Long pledgerNode,
	...
	public String toString() {
		return "BenchmarkReportDTO [metric=" + metric + ", tool=" + tool + ", workloadId=" + workloadId + ", category=" + category
